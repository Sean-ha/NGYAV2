...
public class HelperFunctions
{
	...
	public static Vector2 GetDirectionTowards(Vector2 startPos, Vector2 endPos)
	{
		...
		return GetDirectionFromRAngle(rangle);
	}

	public static Vector2 GetDirectionFromDAngle(float dangle)
	{
		return GetDirectionFromRAngle(dangle * Mathf.Deg2Rad);
	}

	public static Vector2 GetDirectionFromRAngle(float rangle)
	{
